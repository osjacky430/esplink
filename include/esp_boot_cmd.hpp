...
class SYNC {
 public:
  constexpr std::string_view command_name() const noexcept { return "SYNC"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x08; }

  constexpr auto operator()() const noexcept {
    constexpr auto v = []() {
      std::array<std::uint8_t, 36> buff{};
...
struct WRITE_REG {
  constexpr std::string_view command_name() const noexcept { return "WRITE_REG"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x09; }
...
struct READ_REG {
  constexpr std::string_view command_name() const noexcept { return "READ_REG"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x0a; }
...
struct SPI_ATTACH {
  constexpr std::string_view command_name() const noexcept { return "SPI_ATTACH"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x0d; }
...
struct SPI_SET_PARAMS {
  constexpr std::string_view command_name() const noexcept { return "SPI_SET_PARAMS"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x0b; }

  constexpr auto operator()() const noexcept {
    constexpr auto ret_val = []() {
      std::array<std::uint8_t, 6 * sizeof(std::uint32_t)> v;
...
struct FLASH_BEGIN {
  ...
  constexpr std::string_view command_name() const noexcept { return "FLASH_BEGIN"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x02; }

  constexpr auto operator()() const noexcept {
    std::array<std::uint8_t, 5 * sizeof(std::uint32_t)> ret_val{};
...
struct FLASH_DATA {
  ...
  constexpr std::string_view command_name() const noexcept { return "FLASH_DATA"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x03; }

  std::uint8_t check_sum() const noexcept {
    return std::accumulate(this->buffer_.begin(), this->buffer_.begin() + flash_size_, std::uint8_t{0xEF},
                           std::bit_xor{});
  }
...
struct FLASH_END {
  constexpr std::string_view command_name() const noexcept { return "FLASH_END"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x04; }

  constexpr auto operator()() const noexcept {
    return std::array<std::uint8_t, 4>{Opt == FlashEndOption::RunUserCode, 0, 0, 0};
  }
};
...
struct FLASH_READ_SLOW {
  ...
  constexpr std::string_view command_name() const noexcept { return "FLASH_READ_SLOW"; }
  constexpr std::uint8_t command_byte() const noexcept { return 0x0E; }
  ...
  constexpr auto operator()() const noexcept {
    ...
    std::array<std::uint8_t, 8> ret_val;
